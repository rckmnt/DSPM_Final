...
texts = [
  ...
  {key:"coke_adv",    file:"coke_adv.csv",      name:"Coke - Adverbs"}
  {key:"coke_noun",   file:"coke_noun.csv",     name:"Coke - Nouns"}
  {key:"coke_adj",    file:"coke_adj.csv",      name:"Coke - Adjectives"}
  {key:"coke_verb",   file:"coke_verb.csv",     name:"Coke - Verbs"}
  {key:"pepsi_adv",   file:"pepsi_adv.csv",     name:"Pepsi - Adverbs"}
  {key:"pepsi_noun",  file:"pepsi_noun.csv",    name:"Pepsi - Nouns"}
  {key:"pepsi_adj",   file:"pepsi_adj.csv",     name:"Pepsi - Adjectives"}
  {key:"pepsi_verb",  file:"pepsi_verb.csv",    name:"Pepsi - Verbs"}
